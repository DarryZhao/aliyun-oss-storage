    ...
    public function getUrl($path)
    {
        ...
        if (!empty($this->cdnDomain)) {
            if (Str::startsWith($this->cdnDomain, ['https://', 'http://'])) {
                ...
                $host = ($this->ssl ? 'https://' : 'http://') . $this->cdnDomain;
            }
        } else {
            if (Str::startsWith($this->endPoint, ['https://', 'http://'])) {
                $host = str_replace(['https://', 'http://'], ["https://{$this->bucket}.", "http://{$this->bucket}."], $this->endPoint);
            } else {
                $host = ($this->ssl ? 'https://' : 'http://') . $this->bucket . '.' . $this->endPoint;
            }
        }
